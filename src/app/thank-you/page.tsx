...
import thankyouImage from "../../../public/checkout-thank-you.jpg"
...
import PyamentStatus from "@/components/PyamentStatus"
...
const Page = async ({ searchParams }: PageProps) => {
    ...
    return (
        ...
        <main className="relative lg:min-h-full">
            <div className="h-80 overflow-hidden lg:absolute lg:h-full lg:w-1/2 lg:pr-4 xl:pr-12 hidden lg:block ">
                <Image src={thankyouImage} alt="thankYou image" fill
            ...
            <div className='mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24'>
                <div className='lg:col-start-2'>
                    ...
                    <div className='mt-16 text-sm font-medium'>
                        ...
                        <PyamentStatus isPaid={order._isPaid} orderId={order.id} orderEmail={(order.user as User).email} /> 
